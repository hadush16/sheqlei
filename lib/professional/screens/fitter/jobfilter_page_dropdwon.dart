...
import 'package:sheqlee/professional/providers/filter/level_type_dynamic_provider.dart'; // Meta data
...
class _JobFilterPageState extends ConsumerState<JobFilterPage> {
  ...
  JobType? _selectedType; // Store the whole object
  JobLevel? _selectedLevel;
  ...
  Widget build(BuildContext context) {
    ...
    final types = ref.watch(dynamicJobTypesProvider);
    ...
    bool hasSelection =
        _selectedType != null ||
        _selectedLevel != null ||
        _selectedCategory != null; // Use the object here
    return Scaffold(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        // ),
                        // --- REPLACE YOUR CURRENT AppDropdown BLOCK WITH THIS ---
                        categoriesAsync.when(
                          data: (categoriesList) => AppDropdown<Category>(
                            hint: "Categories",
                            // Black hint
                                ...
                                onChanged: (val) {
                                  setState(() {
                                    _selectedLevel =
                                        val; // Store the WHOLE object
                                    isLevelOpen = false;
                                    // Accessing the internal value if needed: print(val?.levelValue);
                                  });
                                },
                                onTap: () => setState(() {
                          ...
                          ? () {
                              ref
                                ...
                                typeId: _selectedType
                                    ?.id, // Use the ID from the selected object
